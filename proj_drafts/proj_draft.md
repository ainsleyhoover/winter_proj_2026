...
To Do still: abstract, intro, titles, sources, data and methods, discussion, sources

data: L2, 1% of NY State voter file 2021

research question: what effect does age, gender, and income have on party affiliation in NY?
...
For this report, we analyzed data of New York voter files from 2021. In it were registered voters' names, registered addresses, ages, vote histories, and party affiliations, among hundreds of other variables. We obtained this data from L2, a gold-standard database for the United States' voter files. We received this data through Professor Joshua Ferrer's access and he gave us a 1% of the raw data. This is still statistically relevant as the sliced data still contained 125,046 voters with 1,180 variables about them. This data is very rich in content, but some variables lacked enough presence to be useful. For example, the education data is an estimate from consumer-sold data. Despite this information being wildly circulated online, half of the New Yorkers were missing data. For this reason, it did not feel as a representative metric to use. This led us to analyzing age, gender, and income as over 90% of voters had that information.
