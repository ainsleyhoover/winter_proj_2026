...
This study examines how well age, income, and gender predict party identification among registered voters in New York State. Using a 1% sample of the 2021 New York voter file from L2 (N ≈ 84,000), we estimate the predictive power of these demographic variables using statistical classification methods. We find that income and age provide modest predictive value for distinguishing between Democratic and Republican affiliation, while gender contributes comparatively little explanatory power. Overall, demographic variables alone perform weakly at the individual level, highlighting the limits of commonly cited partisan generalizations. These findings suggest that while demographic trends exist in aggregate, party identification in New York is shaped by factors beyond basic individual characteristics.
...
Tomkins, S., Rothschild, D., Liu, A., & Thompson, A. (2025). *Identity isn’t everything—How far do demographics take us towards self-identified party ID?* (No. arXiv:2507.06193). arXiv. <https://doi.org/10.48550/arXiv.2507.06193> \>\>\>\>\>\>\> 12eb03cb2a1354f6f5e1d5ce050c5f553c3dd817
